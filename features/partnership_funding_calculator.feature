...
Scenario: Partnership funding calculator version 2 can be uploaded 
    Given I sign in as a "dual_rma" user
     ...
     When I upload a project funding calculator file "Partnership_funding_calculator_2020_for_FCERM_Grant-in-Aid.xlsx"
     Then I can see the file has been uploaded in the proposal overview page
